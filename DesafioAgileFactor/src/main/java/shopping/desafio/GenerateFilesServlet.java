...
public class GenerateFilesServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Product> prods = (ArrayList<Product>)session.getAttribute("cartproducts");
		ArrayList<Integer> quantity = (ArrayList<Integer>)session.getAttribute("productsquantity");
		...
		String timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss").format(Calendar.getInstance().getTime());
	      try {
	         ...
	         e.printStackTrace();
	         System.out.println("Exception in GenerateFiles ::"+e.getMessage());
	      }
